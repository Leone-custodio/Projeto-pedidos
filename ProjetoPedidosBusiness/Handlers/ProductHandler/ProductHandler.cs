...
{
    public class ProductHandler : IRequestHandler<CreateProductRequest, object>
    {
        ...
        public async Task<object> Handle(CreateProductRequest request, CancellationToken cancellationToken)
        {
