...
{
    public class InsertProductsOrderHandler : IRequestHandler<InsertProductsOrderRequest, object>
    {
        ...
        public async Task<object> Handle(InsertProductsOrderRequest request, CancellationToken cancellationToken)
        {
